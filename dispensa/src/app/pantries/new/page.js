      ...
      >
        ...
        >
          <div className="mb-6 text-center">
            <h2 className="text-xl font-bold tracking-tight text-gray-900 mb-1">Nova Despensa</h2>
            <p className="text-sm text-gray-500">Crie um novo espaço para gerenciar seus produtos.</p>
          </div>
